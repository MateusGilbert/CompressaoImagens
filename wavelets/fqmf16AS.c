...
/* IMPORTANT! the matrixes passed as parameters must be of type short int */
int
subsynt(double *pIMG[], short int xsize,
		short int ysize, short int xLsrc,
		short int yLsrc, short int xHsrc,
		short int yHsrc, short int xdst,
		short int ydst, int h_v)
...
/* double *pIMG[];
 short int xLsrc, yLsrc, xHsrc, yHsrc, xsize, ysize, xdst, ydst;
 int h_v; */
...
{
 static double g0[LLENGTH] = { 0.001050167, -0.005054526,  -0.002589756,  0.0276414, -0.009666376,  -0.09039223,  0.09779817,  0.4810284,  0.4810284,  0.09779817, -0.09039223, -0.009666376,  0.0276414, -0.002589756, -0.005054526,  0.001050167  };
													/* these coefficients */
											        /* must be divided by 2 */
 double gg0[LLENGTH];
 static double g1[HLENGTH] = { -0.001050167, -0.005054526,   0.002589756,  0.0276414,  0.009666376,  -0.09039223, -0.09779817,  0.4810284,  -0.4810284,  0.09779817,  0.09039223, -0.009666376, -0.0276414, -0.002589756,  0.005054526,  0.001050167 };
													/* these coefficients */
 ...
 short int per; /* holds the period of the symmetric extension */

 short int k,m,i,j; /* indices */

 short int r,s; /* indices that go through rows and columns, alternately */
 short int rdim, sdim; /* bounds for variation of r and s , respectively */
				       /* the filtering will always be done on sdim */
					   /* unidimensional vectors of length rdim */
 short int a,b; /* limits of summations */
