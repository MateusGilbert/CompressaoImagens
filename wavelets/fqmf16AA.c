...
int
subanal(double *pIMG[], short int xsize,
		short int ysize, short int xsrc,
		short int ysrc, short int xLdst,
		short int yLdst, short int xHdst,
		short int yHdst, int h_v)
 ...
 /*double *pIMG[];
 short int xsrc, ysrc, xsize, ysize, xLdst, yLdst, xHdst, yHdst;
 int h_v;*/
...
{
 static double h0[LLENGTH] = { 0.001050167, -0.005054526,  -0.002589756,  0.0276414, -0.009666376,  -0.09039223,  0.09779817,  0.4810284,  0.4810284,  0.09779817, -0.09039223, -0.009666376,  0.0276414, -0.002589756, -0.005054526,  0.001050167  };
												  /* these coefficients */
												  /* must be normalized */
 double hh0[LLENGTH];
 static double h1[HLENGTH] = { 0.001050167,  0.005054526,  -0.002589756, -0.0276414, -0.009666376,   0.09039223,  0.09779817, -0.4810284,  0.4810284, -0.09779817, -0.09039223,  0.009666376,  0.0276414,  0.002589756, -0.005054526, -0.001050167  };  
												  /* these coefficients */
												  /* must be normalized */
 double hh1[HLENGTH];
